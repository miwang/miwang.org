...
const fullWordData = [
    // --- 九月 September ---
    { char: "四", week: "September", phrases: ["四月", "四岁", "四只小猫"] },
    { char: "五", week: "September", phrases: ["五月", "五岁", "五点"] },
    { char: "六", week: "September", phrases: ["六月", "六岁", "六点"] },
    { char: "七", week: "September", phrases: ["七月", "七岁", "七点"] },
    { char: "八", week: "September", phrases: ["八月", "八岁", "八点"] },
    { char: "九", week: "September", phrases: ["九月", "九岁", "九点"] },
    { char: "十", week: "September", phrases: ["十月", "十岁", "十点"] },
    ...
    { char: "目", week: "December", phrases: ["目标", "节目", "数学题目"] },
    { char: "耳", week: "December", phrases: ["耳朵", "耳机", "耳环", "耳光"] },
    { char: "人", week: "December", phrases: ["超人", "家人", "军人", "雪人", "无人机"] },
    { char: "要", week: "December", phrases: ["我要加一分。", "要睡觉", "我要吃饭。", "要喝水"] },

    // --- 一月 January ---
    { char: "上", week: "January", phrases: ["上面", "上学", "上车", "上班"] },
    ...
    { char: "山", week: "February", phrases: ["上山", "下山", "火山", "冰山", "雪山"] },
    { char: "水", week: "February", phrases: ["水果", "水杯", "水上乐园", "喝水", "水星"] },

    // --- 三月 March ---
    { char: "和", week: "March", phrases: ["我和爸爸", "和我一样", "和朋友一起", "我和妈妈"] },
    { char: "土", week: "March", phrases: ["不可以玩土", "土豆", "土星", "泥土"] },
    { char: "木", week: "March", phrases: ["木头", "木星", "木船", "啄木鸟"] },
    ...
    { char: "也", week: "April", phrases: ["我也累了。", "我也爱你。", "我也饿了。"] },

    // --- 五月 May ---
    { char: "了", week: "May", phrases: ["我困了。", "我渴了。", "我尽力了。", "我饿了。"] },
    { char: "火", week: "May", phrases: ["火星", "火车", "火", "火鸡", "火山"] }
];